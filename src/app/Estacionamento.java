...
public class Estacionamento {
    public static void main(String[] args) {
        ...
        System.out.println("Bem-vindo ao Estaciomento do Freitas!");
    ...
    public static void cadastrarVeiculo(Scanner scanner) {
        ...
        try{
            switch (tipo) {
                case "M":
                    System.out.println("Informe as 3 letras da placa da moto:");
                    String letrasPlacas = scanner.next();
                    System.out.println("Informe os 4 numeros da placa da moto:");
                    int numerosPlaca = scanner.nextInt();
